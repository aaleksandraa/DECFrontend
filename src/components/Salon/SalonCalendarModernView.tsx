                            ...
                            <div className="flex items-start gap-2">
                              <div className="flex-1 min-w-0">
                                ...
                                <div className="text-xs text-gray-500 mt-1">
                                  {apt.time || apt.start_time} - {apt.end_time}
                                </div>
        ...
        >
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="text-sm text-gray-600">Zaposleni</label>
                <div className="font-medium text-gray-900">{selectedAppointment.staff_name}</div>
              </div>

              <div>
                <label className="text-sm text-gray-600">Vrijeme</label>
                <div className="font-medium text-gray-900">
                  {selectedAppointment.date} {selectedAppointment.time || selectedAppointment.start_time} - {selectedAppointment.end_time}
                </div>
              </div>
